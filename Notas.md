...
Crie uma pasta chamada "psqlite" e copie os arquivos "programa.py" e "utils.py" para dentro dela.

Por padrão as versões mais novas do Python já vêm com suporte ao SQLite, então não é preciso instalar nenhum *driver*. Importe a livraria sqlite3 no começo do arquivo "utils.py".
...
Crie uma pasta chamada "predis" e copie os arquivos "utils.py" e "programa.py" para dentro dela.

Instale o driver pelo seguinte comando: `pip install redis`. Importe o Redis no arquivo "utils.py".

É necessário que o servidor Redis fique rodando no fundo. Para que isso aconteça ative o Redis como serviço.

**Gerando um id**

Precisamos criar uma nova função para ter um padrão para a inserção e consulta dos dados.
...
Crie uma pasta chamada "jmongodb" e copie os arquivos "Programa.java" e "Utils.java" para ela.

Baixe o driver do MongoDB, JSON e BSON e instale-os na pasta "Referenced Libraries".

Abra o MongoDB Compass e crie um banco de dados chamado "jmongo" e uma coleção chamada "produtos".

Importe todas as livrarias necessárias quando estiver escrevendo o código.
...
public static void atualizar() {
    ...
    try {
        ...
        if (res.getModifiedCount() == 1) {
            ...
            System.out.println("O produto não pôde ser atualizado.");
        }
...
Crie uma pasta chamada "jredis" e copie os arquivos "Programa.java" e "Utils.java" para ela.

Instale o driver do Redis na pasta "Referenced Libraries". O driver mais famoso para o Redis no Java é o Jedis.

Se você estava usando o Redis com outra linguagem de programação, reinicie-o.

**Criando a função `gera_id()`**
